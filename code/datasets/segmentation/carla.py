...
class _Carla(data.Dataset):
    """Base class
    This contains fields and methods common to all Carla datasets
    """

    def __init__(self, config=None, split=None, purpose=None, preload=False):
        super(_Carla, self).__init__()
        ...
        # assert (os.path.exists(os.path.join(self.root, "debugged.out"))) # No need for debugged.out in Carla dataset
    ...
    def _load_data(self, image_id):
        image_path = osp.join(self.root, "imgs", image_id + ".png")
